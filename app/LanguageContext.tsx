...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.description': "Software Engineer with 4+ years of experience building web applications, ERP systems, and cloud-based solutions. Skilled in React, Django, and PostgreSQL with a strong background in AI and computer vision. Currently based in Vancouver, Canada, open to new opportunities.",
  ...
  es: {
    ...
    'hero.description': 'Ingeniero de Software con más de 4 años de experiencia desarrollando aplicaciones web, sistemas ERP y soluciones en la nube. Especializado en React, Django y PostgreSQL, con sólida formación en inteligencia artificial y visión por computadora. Actualmente en Vancouver, Canadá, abierto a nuevas oportunidades.',
